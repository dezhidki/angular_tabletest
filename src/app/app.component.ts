...
@Component({
    ...
    template: `
        ...
        <p>
            ...
            Testin päätavoite on tarkastella datan näyttämiseen kuluva aika siitä hetkestä, kun käyttäjä painaa "näytä taulu".
        </p>
        ...
        <ul>
            ...
            <li>Jokaisella solulla on oma tyyli ja omat näkyvyysasetukset, joita tarkistetaan taulukon generoinnin aikana</li>
            ...
            <li><strong>Testien välissä sivu virkistetään, jotta edellisen taulun DOM-puu ei voisi vaikuttaa toisen taulun
                generointiaikoihin.</strong></li>
            <li>Ylimääräiset painikkeet ja toiminnot on jätetty pois testataakseen ainoastaan itse taulun generointiin kuluva aika.</li>
        </ul>
        ...
        <ul>
            ...
            <li>Eniten aikaa menee DOMPurify-sanitointikutsuissa
                <ul>
                    <li>Osin johtuu siitä, että DOMPurify luo oman piilo-DOMin, jonka avulla se suorittaa sanitoinnin</li>
        ...
        <ul>
            ...
            <li>Eniten aikaa menee DOM API-kutsuihin, koska niitä on tosi paljon
                <ul>
                    <li>Johtuu todnäk siitä, että jokainen DOM API-kutsu menee suoraan selaimen moottoriin asti, mikä vaatii JS --> native tyyppimuunnoksia ja -tarkistuksia.</li>
                </ul>
            </li>
            <li>DOMPurify-sanitointi saatu erittäin nopeaksi (~100 ms tasolle)
                <ul>
                    <li>Sanitointi tehdään suoraan koko taulukon DOMille, jolloin DOMPurify ei luo piilo-DOMia vaan käyttää suoraan generoitavaa taulukkoa.</li>
                </ul>
            </li>
            <li>Reaktiivisuus onnistuu hyvin
                <ul>
                    <li>Koska luodaan suoraan DOM-puu käsin, saadaan suoran viitteet DOM-elementteihin, joita voidaan helposti manipuloida</li>
                </ul>
            </li>
        </ul>
        ...
        <p>Taulu, joka generoi taulukon HTMLän merkkijonoon, sanitoi sen ja asettaa Angular-komponentiin innerHTML-ominaisuudella</p>
        <p>Huomioita</p>
        <ul>
            <li>Chromella näyttäisi olevan nopein tapa, jolla generoidaan koko taulukko
                <ul>
                    <li>Johtuu todnäk siitä, että usean DOM API:n kutsun sijaan tehdään vain yksi innerHTML-asettelu, jolloin itse DOM-puun generointi tapahtuu suoraan selaimen moottorissa</li>
        ...
        <ul>
            ...
            <li>DOMPurify samalla tavalla kuin Angular taulussa, mutta tehdään laiskasti, minkä takia se on nopeaa</li>
            <li>Skrollaus voi hitaammilla koneilla olla vähän hitaampaa, koska skrollauksen yhteydessä pitää päivittää solujen sisältö</li>
            <li>Rivien ja sarakkeiden liimaus yhteen onnistuu</li>
            <li>DOM taulun tapaan on pääsy suoraan DOM-elementteihin, jolloin tapahtumien käsittely onnistuu helposti</li>
            <li>Edellyttää, että osataan laskea/tunnetaan rivien korkeudet ja sarakkeiden leveydet</li>
            <li>Voidaan helposti yhdistää DOM taulun kanssa, jolloin saadaan "hybridi", joka tarpeen mukaan voi toimia virtuaalisena tai täydellisenä</li>
        </ul>
